...
public class Organizations extends TableImpl<OrganizationsRecord> {
     ...
     */
    public final TableField<OrganizationsRecord, Long> INN = createField(DSL.name("inn"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.organizations.account</code>.
     */
    public final TableField<OrganizationsRecord, Long> ACCOUNT = createField(DSL.name("account"), SQLDataType.BIGINT.nullable(false), this, "");
